                        ...
                        if(isset($_POST['reporttodate'])):
                            ...
                            if($sales_list):
                                ...
                                while($row=$sales_list->fetch_array()):
                                    ...
                                    <?php
                                    $sql=mysqli_query($conn,"SELECT i.product_id,i.qty,i.price,(i.qty*i.price) as amount,s.ref_no,s.customer_id from inventory i LEFT JOIN sales_list s ON i.remarks LIKE concat('%','".$row["ref_no"]."','%') WHERE i.type=2 and stock_from='Sales' and i.date_updated BETWEEN '$f' and '$e'" );
                                    if ($sql) {
                                        // $p=$sql->fetch_array();
